                ...
                <TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
                    ...
                    <TR>
                        ...
                        <TD class=category width="35%">
                            <div style="width:100%">
                                <input class="imput_text" type="text" id="login_name" name="login_name"/>
                            </div>
                    ...
                    <TR>
                        ...
                        <TD class=category width="35%">
                            <div style="width:100%">
                                <input class="imput_text" type="text" id="user_name" name="user_name"/>
                            </div>
                    ...
                    <TR>
                        ...
                        <TD class=category width="35%">
                            <div style="width:100%">
                                <input class="imput_text" type="text" id="phone" name="phone"/>
                            </div>
                            <div id="phoneTip"></div>
                        </TD>
                    </TR>
                    <TR>
                        ...
                        <TD class=category width="35%">
                            <div style="width:100%">
                                <textarea rows="3" cols="20" name="password" class="imput_text"></textarea>
                            </div>
                        </TD>
                    </TR>
                    <tr>
