...
<head>
    ...
    <script type="text/javascript" src="assets/ajax_js/project.js"></script>
</head>
<body>
<!-- Start #header -->
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-lg-12 heading">
                <h1 class="page-header"><i class="im-table2"></i> 项目管理</h1>
                <!-- Start .bredcrumb -->
                ...
                <div class="option-buttons">
                    <div class="btn-toolbar" role="toolbar">
                        ...
                        <div class="btn-project dropdown">
                            ...
                            <div class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu2">
                                <div class="option-dropdown">
                                    <div class="row">
                                        ...
                                        <form id="project_edit" class="form-horizontal" onsubmit="return edit();">
                                            ...
                                            <div class="form-project">
                                                <div class="col-lg-12">
                                                    <textarea name="test_progress" class="form-control wysiwyg"
                                                              placeholder="测试进度"></textarea>
                                                </div>
                                            </div>
                                            <!-- End .form-project  -->
                                            <div class="form-project">
                                                <div class="col-lg-12">
                                                    <textarea name="case_list" class="form-control wysiwyg"
                                                              placeholder="用例ID列表"></textarea>
                                                </div>
                                            </div>
                                            <!-- End .form-project  -->
                                            <div class="form-project">
                                                <div class="col-lg-12">
                                                    <textarea name="user_list" class="form-control wysiwyg"
                                                              placeholder="测试人员ID列表"></textarea>
                                                </div>
                                            </div>
                                            <!-- End .form-project  -->
                        ...
                        <div class="panel-body">
                            <table class="table" id="project">
                                ...
                                <tr>
                                    ...
                                    <th class="per15">项目名称</th>
                                    <th class="per10">项目描述</th>
                                    <th class="per10">测试进度</th>
                                    <th class="per15">用例列表</th>
                                    <th class="per10">测试员列表</th>
